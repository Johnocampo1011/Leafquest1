export const basicQuestions = [
  ...
  export const professionalQuestions = [
    ...
    {
      "question": "Which plant structure is responsible for sensing gravity?",
      "options": [
        { "text": "Statoliths", "isCorrect": true },
        { "text": "Chloroplasts", "isCorrect": false },
        { "text": "Stomata", "isCorrect": false },
        { "text": "Xylem cells", "isCorrect": false }
      ]
    },
    {
      "question": "Which mycorrhizal association penetrates root cells?",
      "options": [
        { "text": "Arbuscular mycorrhizae", "isCorrect": true },
        { "text": "Ectomycorrhizae", "isCorrect": false },
        { "text": "Endophytes", "isCorrect": false },
        { "text": "Lichens", "isCorrect": false }
      ]
    },
    {
      "question": "Which enzyme catalyzes the fixation of CO2 in the Calvin cycle?",
      "options": [
        { "text": "Rubisco", "isCorrect": true },
        { "text": "ATP synthase", "isCorrect": false },
        { "text": "PEP carboxylase", "isCorrect": false },
        { "text": "Nitrate reductase", "isCorrect": false }
      ]
    },
    {
      "question": "Which plant pigment is responsible for absorbing blue light for phototropism?",
      "options": [
        { "text": "Cryptochrome", "isCorrect": true },
        { "text": "Phytochrome", "isCorrect": false },
        { "text": "Chlorophyll b", "isCorrect": false },
        { "text": "Carotenoids", "isCorrect": false }
      ]
    },
    {
      "question": "Which type of reproduction occurs in ferns?",
      "options": [
        { "text": "Alternation of generations", "isCorrect": true },
    ...
    {
      "question": "Which secondary metabolite gives garlic its smell and antibacterial properties?",
      "options": [
        { "text": "Allicin", "isCorrect": true },
        { "text": "Quercetin", "isCorrect": false },
        { "text": "Capsaicin", "isCorrect": false },
        { "text": "Lignin", "isCorrect": false }
      ]
    },
    {
      "question": "What adaptation allows mangroves to survive in saline environments?",
      "options": [
        { "text": "Salt-excreting glands", "isCorrect": true },
        { "text": "Extra chlorophyll", "isCorrect": false },
        { "text": "Nitrogen fixation", "isCorrect": false },
        { "text": "Large flowers", "isCorrect": false }
      ]
    },
    {
      "question": "Which plant produces quinine, a treatment for malaria?",
      "options": [
        { "text": "Cinchona", "isCorrect": true },
        { "text": "Digitalis", "isCorrect": false },
        { "text": "Atropa belladonna", "isCorrect": false },
        { "text": "Erythroxylum coca", "isCorrect": false }
      ]
    },
    {
      "question": "Which element is a central atom in chlorophyll?",
      "options": [
    ...
    {
      "question": "What is the function of pneumatophores in mangroves?",
      "options": [
        { "text": "Gas exchange", "isCorrect": true },
        { "text": "Nutrient storage", "isCorrect": false },
        { "text": "Salt absorption", "isCorrect": false },
        { "text": "Seed dispersal", "isCorrect": false }
      ]
    },
    {
      "question": "Which gas do CAM plants uptake at night?",
      "options": [
    ...
    {
      "question": "Which crop was the first genetically modified for commercial use?",
      "options": [
        { "text": "Tomato (Flavr Savr)", "isCorrect": true },
        { "text": "Corn", "isCorrect": false },
    ...
    {
      "question": "Which alkaloid is extracted from the opium poppy?",
      "options": [
    ...
    {
      "question": "Which desert plant can survive years without rainfall?",
      "options": [
        { "text": "Welwitschia mirabilis", "isCorrect": true },
        { "text": "Cactus", "isCorrect": false },
        { "text": "Euphorbia", "isCorrect": false },
        { "text": "Agave", "isCorrect": false }
      ]
    },
    {
      "question": "Which type of meristem is responsible for primary growth?",
      "options": [
        { "text": "Apical meristem", "isCorrect": true },
        { "text": "Lateral meristem", "isCorrect": false },
        { "text": "Intercalary meristem", "isCorrect": false },
        { "text": "Secondary cambium", "isCorrect": false }
      ]
    },
    {
      "question": "What is the primary role of phytochrome pigments?",
      "options": [
        { "text": "Light sensing (red/far-red)", "isCorrect": true },
        { "text": "Photosynthesis", "isCorrect": false },
        { "text": "Oxygen release", "isCorrect": false },
        { "text": "Sugar transport", "isCorrect": false }
      ]
    },
    {
      "question": "Which part of the plant is modified into a bulb in onions?",
      "options": [
        { "text": "Stem", "isCorrect": true },
        { "text": "Root", "isCorrect": false },
        { "text": "Leaf", "isCorrect": false },
        { "text": "Flower", "isCorrect": false }
      ]
    ...
    {
      "question": "Which crop was central to the Irish Potato Famine?",
      "options": [
        { "text": "Potato (Solanum tuberosum)", "isCorrect": true },
        { "text": "Maize", "isCorrect": false },
        { "text": "Wheat", "isCorrect": false },
        { "text": "Rye", "isCorrect": false }
      ]
    },
    {
      "question": "Which compound gives chili peppers their heat?",
      "options": [
        { "text": "Capsaicin", "isCorrect": true },
        { "text": "Piperine", "isCorrect": false },
        { "text": "Curcumin", "isCorrect": false },
        { "text": "Allicin", "isCorrect": false }
      ]
    }
  ]
